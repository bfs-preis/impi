...
//  - ESM (tsc output, ts-node tests, Electron): `import.meta.url` is set.
 ...
 * virtual snapshot, so a plain `require('sqlite3')` resolves against the
 ...
 *
 * Outside pkg (normal Node, Electron) this is just a plain require.
 */
